...
function Field({
  ...
  const baseStyles = "group/field flex w-full gap-3 data-[invalid=true]:text-destructive"
  ...
  return (
    <div
      ...
      className={cn(baseStyles, "flex-col [&>*]:w-full [&>.sr-only]:w-auto", orientationStyles[orientation], className)}
      {...props}
    />
  )
}
