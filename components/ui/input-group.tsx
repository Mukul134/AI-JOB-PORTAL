...
const buttonSizeStyles: Record<InputGroupButtonSize, string> = {
...
function InputGroupAddon({
  ...
  return (
    <div
      ...
      data-align={align}
      className={cn(baseStyles, addonAlignStyles[align], className)}
      onClick={(e) => {
...
function InputGroupButton({
  ...
  return (
    <Button
      ...
      data-size={size}
      variant={variant}
      className={cn("text-sm shadow-none flex gap-2 items-center", buttonSizeStyles[size], className)}
      {...props}
    />
  )
}
