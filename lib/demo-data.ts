...
// Demo jobs database - used for AI recommendations
export const DEMO_JOBS = [
  {
    id: "job-1",
    title: "Python Developer Intern",
    company: "TechNova",
    description: "Looking for an enthusiastic Python developer intern to join our team. Work on real-world projects using Django and FastAPI.",
  ...
  },
  {
    ...
    company: "CodeCraft",
    description: "Experienced Frontend Developer needed to build responsive web applications using modern frameworks and tools.",
  ...
  },
  {
    ...
    company: "VisionAI",
    description: "Join our AI team to develop machine learning models and deploy them to production. Experience with TensorFlow and PyTorch required.",
  ...
  },
  {
    ...
    company: "UrbanFix",
    description: "Professional plumber needed for residential and commercial projects. Must have certification and 2+ years experience.",
  ...
  },
  {
    ...
    description: "Full Stack Developer to build complete web applications. Work with Node.js backend and React frontend.",
  ...
  },
  {
    ...
    description: "Software Developer to work on various projects using Java and C++. Fast-paced environment with continuous learning.",
  ...
  },
  {
    ...
    description: "Analyze complex datasets and create actionable insights. Work with SQL, Python, and BI tools like Tableau.",
  ...
  },
  {
    ...
    company: "DesignHub",
    description: "Creative UX/UI Designer to create beautiful and intuitive interfaces. Experience with Figma and design systems.",
